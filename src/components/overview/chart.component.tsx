...
function ChartCard() {
  ...
  return (
    <div className="col-span-full flex flex-col rounded-lg bg-wagpay-primary font-inter shadow-lg xl:col-span-8">
      <header className="flex items-center border-b border-gray-600 px-5 py-4">

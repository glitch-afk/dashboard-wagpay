...
function Sidebar({ sidebarOpen, setSidebarOpen }: ISidebarProps) {
  ...
  return (
    <div>
      ...
      <div
        className={`fixed inset-0 flex bg-wagpay-primary bg-opacity-30 z-40 lg:hidden lg:z-auto transition-opacity duration-200 ${
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-hidden lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 flex-shrink-0 bg-wagpay-primary p-4 transition-all duration-200 ease-in-out ${
        ...
        <div className="space-y-8">
          ...
          <div>
            <ul>
                ...
                <Link href="/">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span
                        className={`ml-3 text-sm duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 ${
                          pathname === '/' && 'text-base'
                        }`}
                      >
                        Overview
                    ...
                    <div className="flex items-center">
                      <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                        ...
                        <path
                          ...
                          className={`fill-current text-gray-400 ${
                            pathname.includes('pages') && 'text-indigo-200'
                          }`}
                        />
                        <path
                      ...
                      <span
                        className={`ml-3 text-sm duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 ${
                          pathname.includes('pages') && 'text-base'
                        }`}
                      >
                        Pages
                      </span>
                    ...
                    <div className="flex items-center">
                      <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                        ...
                        <path
                          ...
                          className={`fill-current text-gray-400 ${
                            pathname.includes('products') && 'text-indigo-200'
                          }`}
                        />
                        <path
                      ...
                      <span
                        className={`ml-3 text-sm duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 ${
                          pathname.includes('products') && 'text-base'
                        }`}
                      >
                        Products
                      </span>
                ...
                <Link href="/subscription">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span
                        className={`ml-3 text-sm duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 ${
                          pathname.includes('subscription') && 'text-base'
                        }`}
                      >
                        Subscription
                      </span>
                    ...
                    <div className="flex items-center">
                      <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                        <path
                          ...
                          className={`fill-current text-gray-400 ${
                            pathname.includes('invoices') && '!text-indigo-500'
                          }`}
                        />
                        <path
                          fillRule="evenodd"
                      ...
                      <span
                        className={`ml-3 text-sm duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 ${
                          pathname.includes('invoices') && 'text-base'
                        }`}
                      >
                        Invoices
                      </span>
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-2 last:mb-0 ${
                  pathname.includes('transactions') && 'bg-gray-900'
                }`}
              >
                <Link href="/transactions">
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <span
                        className={`ml-3 text-sm duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 ${
                          pathname.includes('transactions') && 'text-base'
                        }`}
                      >
                        Transactions
                      </span>
          ...
          <div>
            ...
            <ul className="mt-3">
                    ...
                    <div className="flex items-center">
                      <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                        ...
                        <path
                          ...
                          className={`fill-current text-gray-400 ${
                            pathname.includes('settings') && 'text-indigo-200'
                          }`}
                        />
                      </svg>
                      <span
                        className={`ml-3 text-sm duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 ${
                          pathname.includes('settings') && 'text-base'
                        }`}
                      >
                        Settings
                      </span>
              ...
              <li
                className={`px-3 py-2 rounded-sm mb-2 last:mb-0 ${
                  pathname.includes('docs') && 'bg-gray-900'
                }`}
              >
                <Link href="/docs">
                  <a
                    className={`block text-gray-200 hover:text-white truncate transition duration-150 ${
                      pathname.includes('docs') && 'hover:text-gray-200'
                    }`}
                  >
                    <div className="flex items-center">
                      <svg className="h-6 w-6 shrink-0" viewBox="0 0 24 24">
                        <path
                          ...
                          d="M3 4C3 2.34315 4.34315 1 6 1H15.7574C16.553 1 17.3161 1.31607 17.8787 1.87868L20.1213 4.12132C20.6839 4.68393 21 5.44699 21 6.24264V20C21 21.6569 19.6569 23 18 23H6C4.34315 23 3 21.6569 3 20V4Z"
                          className={`fill-current text-gray-400 ${
                            pathname.includes('docs') && '!text-indigo-500'
                          }`}
                        />
                        <path
                          d="M11 12C11 11.4477 11.4477 11 12 11C12.5523 11 13 11.4477 13 12V17C13 17.5523 12.5523 18 12 18C11.4477 18 11 17.5523 11 17V12Z"
                          className={`fill-current text-gray-400 ${
                            pathname.includes('docs') && 'text-indigo-200'
                          }`}
                        />
                        <path
                          d="M7 15C7 14.4477 7.44772 14 8 14C8.55229 14 9 14.4477 9 15V17C9 17.5523 8.55229 18 8 18C7.44772 18 7 17.5523 7 17V15Z"
                      ...
                      <span
                        className={`ml-3 text-sm duration-200 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 ${
                          pathname.includes('docs') && 'text-base'
                        }`}
                      >
                        Documentation
                      </span>
